...
{
  "$end", "error", "$undefined", "CMDTOKEN", "NEWLINE", "$accept",
  "source", "commandline", "args", "commands", "command", YY_NULLPTR
};
#endif
...
#line 75 "parser.y" /* yacc.c:1646  */
    {
       ...
       int pid = fork();
       if (!pid){
           if (execve((yyvsp[-1].str), args + argsIndex, env) < 0) {
